...
class MyAdapterPlaylist(private val playlistList: MutableList<myPlaylist>,
    private val contextExt: Context): RecyclerView.Adapter<MyAdapterPlaylist.MyViewHolder>() {
